...
This repository has QIIME 2 compatible files, metadata, R code, and all other input files needed for analysis and figure generation for the following manuscript:
...
R code is available in the `code` folder.
